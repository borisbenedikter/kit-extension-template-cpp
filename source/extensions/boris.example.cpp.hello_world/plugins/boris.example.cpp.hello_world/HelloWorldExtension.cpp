...
const struct carb::PluginImplDesc pluginImplDesc = { "boris.example.cpp.hello_world.plugin",
...
public:
    ...
    void onUpdate()
    {
        ...
        {
            printf("Hello from the boris.example.cpp.hello_world extension! %d updates counted.\n", m_updateCounter);
        }
        m_updateCounter++;
    }
...
CARB_PLUGIN_IMPL(pluginImplDesc, boris::example::cpp::hello_world::ExampleCppHelloWorldExtension)

void fillInterface(boris::example::cpp::hello_world::ExampleCppHelloWorldExtension& iface)
{
}
