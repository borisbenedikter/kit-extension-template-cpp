...
project_ext_plugin(ext, "boris.example.cpp.usd_physics.plugin")
    add_files("include", "include/boris/example/cpp/usd_physics")
    add_files("source", "plugins/boris.example.cpp.usd_physics")
    includedirs {
        "include",
        "plugins/boris.example.cpp.usd_physics",
